...
namespace SwarmBot
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			//Emotes
			configDir = File.ReadAllLines(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Documents/Projects/SwarmBot/SwarmBot/bin/Release/path.txt"))[0];
